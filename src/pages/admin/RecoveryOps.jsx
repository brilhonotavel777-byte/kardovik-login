...
const INCIDENTS = [
  {
    id: "INC-001",
    service: "OpenAI API",
    impact: "Respostas com latência elevada",
    severity: "medium",
    status: "open",
    origin: "Rate limit / instabilidade provider",
    action: "Monitorar; escalar se >1h",
  },
  {
    id: "INC-002",
    service: "SMTP",
    impact: "2 emails de confirmação não entregues",
    severity: "low",
    status: "investigating",
    origin: "Rate limit temporário",
    action: "Retry automático agendado",
  },
  {
    id: "INC-003",
    service: "Supabase",
    impact: "Nenhum impacto ao usuário",
    severity: "low",
    status: "resolved",
    origin: "Spike de leitura no DB às 07h",
    action: "Resolvido — monitorando",
  },
];

const ERROR_MAP = [
  {
    error:   "Alta latência nas respostas",
    origin:  "OpenAI API instável",
    impact:  "Lentidão para 3 clínicas",
    action:  "Monitorar provider",
    level:   "medium",
  },
  {
    error:   "Email não entregue",
    origin:  "SMTP rate limit",
    impact:  "2 usuários afetados",
    action:  "Retry em fila",
    level:   "low",
  },
];
    ...
    <div style={{ padding: "32px 36px 48px", maxWidth: "1380px" }}>
      ...
      >
        ...
        <div
          style={{
            display: "grid",
            gridTemplateColumns: "80px 1.2fr 2fr 1fr 1.4fr",
            padding: "10px 24px",
